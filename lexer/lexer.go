...
// Lexer is a struct that holds the input string and the current position in the input
type Lexer struct {
	input        string
...
func (l *Lexer) NextToken() token.Token {
	...
	default:
		if isLetter(l.ch) {
			...
			// check if the identifier is a keyword or user-defined identifier
